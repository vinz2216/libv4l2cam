...
public:
    ...
    int match(svs* other, int ideal_no_of_matches, int max_disparity_percent, int learnDesc, int learnLuma, int learnDisp, int learnPrior, int learnGrad, int groundPrior, int use_priors);
